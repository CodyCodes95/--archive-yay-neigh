  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-black text-white">
        ...
        <button className="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900 duration-300">Login</button>
        </Link>
      </nav>
        ...
        <div className="flex flex-col w-[50%] justify-center items-center ">
          <div className="flex">
            <div className="flex flex-col">
              ...
              <input type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} className="w-[85%] text-black" />
            </div>
            <div className="flex flex-col">
              <label className="" htmlFor="">
                City/State*
              </label>
              <input type="text" value={cityState} onChange={(e) => setCityState(e.target.value)} className="w-[85%] text-black" />
            </div>
          </div>
          <div className="flex">
            <div className="flex flex-col">
              ...
              <input type="text" value={email} onChange={(e) => setEmail(e.target.value)} className="w-[85%] text-black" />
            </div>
            <div className="flex flex-col">
              <label className="" htmlFor="">
                Instagram Username*
              </label>
              <input type="text" value={instagramName} onChange={(e) => setInstagramName(e.target.value)} className="w-[85%] text-black" />
            </div>
          </div>
